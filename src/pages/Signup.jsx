...
const Signup = () => {
    ...
    return (
        <AuthLayout>
            ...
            >
                <motion.h1 variants={itemVariants} style={{ fontSize: '2rem', marginBottom: '0.5rem', color: 'var(--text-primary)' }}>Create an Account</motion.h1>
                <motion.p variants={itemVariants} style={{ color: 'var(--text-secondary)', marginBottom: '2.5rem' }}>Start your journey with FileNest today.</motion.p>

                <motion.div variants={itemVariants} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '2rem' }}>
                    <Link to="/login" style={{ textDecoration: 'none' }}>
                        <button className="btn btn-outline" style={{ width: '100%', padding: '0.75rem', border: 'none', background: 'transparent' }}>Sign In</button>
                    </Link>
                    <button className="btn btn-primary" style={{ width: '100%', padding: '0.75rem' }}>Create Account</button>
                </motion.div>
